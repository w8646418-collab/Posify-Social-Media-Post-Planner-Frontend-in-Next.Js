"use client"; // Interactive / client-side safe
...
export default function About() {
  return (
    <div className="min-h-screen bg-linear-to-b from-white via-blue-50 to-indigo-100 text-gray-800">
      ...
      {/* SECTION 2: TEAM */}
      <section className="min-h-screen flex items-center justify-center bg-linear-to-br from-[#fbfafc] via-[#e7e4ea] to-[#d6d5d6] py-24 px-6 relative">
      ...
      <section className="py-20 bg-linear-to-br from-[#e8d5f5] via-[#dabef1] to-[#ddc9ef]">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-8 rounded-2xl border border-[#41058b]/30 hover:border-[#b026ff]/60 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-500">
            ...
            {[
              ...
              <div key={idx} className="flex items-start space-x-4 mb-5 group">
                <div className="w-8 h-8 bg-linear-to-br from-[#f5e1ff] to-[#ede0ff] rounded-lg flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
                  <svg
                ...
                <div>
                  <h3 className="text-[#3b0066] font-semibold">{item.title}</h3>
      ...
      <section className="relative bg-linear-to-b from-[#d3cddb] via-indigo-200 to-purple-300 py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {[
              ...
              >
                <div className="absolute -top-10 -right-10 w-32 h-32 bg-linear-to-br from-indigo-400 via-purple-300 to-pink-300 opacity-20 blur-3xl group-hover:opacity-40 transition-opacity duration-500"></div>
          ...
          <div className="py-16 px-6 bg-white rounded-2xl">
            ...
            <div className="w-full h-96 rounded-3xl overflow-hidden shadow-2xl border-2 border-purple-400">
              <iframe
