...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-b from-white via-blue-50 to-indigo-100 text-gray-800">
      {/* Hero Section */}
      <Hero />
      ...
      {/* Calender */}
      <section className="relative bg-linear-to-b from-purple-200 via-white to-purple-200 py-24 overflow-hidden">
          ...
          <div className="lg:w-1/2 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-6 mt-6">
              {[
                ...
                <div
                  key={i}
                  className="relative bg-white p-6 rounded-3xl shadow-lg hover:shadow-2xl transition-transform transform hover:-translate-y-2"
                >
                  <div
                  ...
                  {/* Decorative ring */}
                  <div
                    className="absolute -top-4 -right-4 w-16 h-16 border-2 rounded-full border-dashed"
            ...
            <div className="mt-8 bg-white/70 backdrop-blur-md rounded-3xl p-6 shadow-lg">
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 rounded-xl hover:bg-white/30 transition"
                  >
            ...
            <div className="bg-white/80 backdrop-blur-md p-6 rounded-3xl shadow-xl">
              ...
              <div className="grid grid-cols-7 gap-2">
                {Array.from({ length: 31 }, (_, i) => i + 1).map((day) => {
                  ...
                  return (
                    <div
                      key={day}
                      className={`group relative p-4 rounded-xl cursor-pointer text-center transition-transform ${isToday
              ...
              <div className="mt-6 flex flex-wrap gap-4 text-xs text-gray-600">
                <span className="flex items-center gap-1">
                  <span className="w-3 h-3 rounded-full bg-[#7a00cc]"></span>{" "}
                  Reel
                </span>
                <span className="flex items-center gap-1">
                  <span className="w-3 h-3 rounded-full bg-[#ff5da2]"></span>{" "}
                  Collab
                </span>
                <span className="flex items-center gap-1">
      ...
      <section className="relative py-24 bg-linear-to-b from-white via-purple-50/40 to-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10">
            <div className="flex-1 border-l-4 border-[#5c2484] pl-6 text-left">
              <h3 className="text-xl font-semibold text-[#5c2484] mb-2">
                Who We Are
              </h3>
      ...
      {/* FAQ */}
      <section className="relative py-32 bg-linear-to-b from-purple-200 via-white to-purple-200 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-12 bg-linear-to-r text-[#5c2484] bg-clip-text t">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={i}
                  className={`${faq.color} rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all duration-500`}
                >
            ...
            <div className="relative bg-white/70 backdrop-blur-md rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col justify-center items-center">
              <div className="text-purple-600 text-6xl mb-4 animate-bounce-slow">
                ❓
              </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <details
                  key={i}
                  className="group bg-white/80 backdrop-blur-md rounded-3xl p-5 shadow-md hover:shadow-xl transition-all duration-500 cursor-pointer border-l-4 border-purple-900"
                >
                  <summary className="flex justify-between items-center font-semibold text-gray-800 list-none">
                    {faq.question}
                    <span className="transition-transform group-open:rotate-45 text-gray-400 text-xl">
                      +
                    </span>
                  </summary>
                  <p className="mt-3 text-gray-700 transition-all duration-500 ease-in-out">
                    {faq.answer}
                  </p>
                </details>
              ))}
      ...
      <section className="relative py-24 bg-linear-to-b from-indigo-50 via-white to-indigo-100 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-16 bg-linear-to-r text-[#5c2484] bg-clip-text ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div
                key={i}
                className={`group relative bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer overflow-hidden border-l-8 border-linear-to-r ${item.color}`}
              >
                ...
                <button className="mt-6 px-6 py-2 bg-linear-to-r from-purple-600 to-purple-300 text-white font-semibold rounded-full shadow-lg hover:shadow-2xl transition-all duration-300">
      ...
      <section className="relative py-24 bg-linear-to-b from-white via-blue-50 to-indigo-100 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-12 flex flex-col md:flex-row gap-4 justify-center items-center">
            ...
            <div class="absolute -left-6 w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center shadow-md">
              <div class="w-10 h-10 rounded-full bg-linear-to-r ${color} flex items-center justify-center text-white font-semibold">${progress}%</div>
            </div>
            <div class="ml-12 p-6 bg-white/80 backdrop-blur-md rounded-3xl shadow-lg w-full">
              ...
              <div class="mt-3 w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                <div class="h-3 rounded-full bg-linear-to-r ${color}" style="width: ${progress}%"></div>
              </div>
          ...
          <div
            id="goalList"
            className="relative border-l-2 border-gray-300 ml-6"
          >
            <div className="relative flex items-center mb-10">
              <div className="absolute -left-6 w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center shadow-md">
                <div className="w-10 h-10 rounded-full bg-linear-to-r from-purple-500 to-purple-300 flex items-center justify-center text-white font-semibold">
                  70%
                </div>
              </div>
              <div className="ml-12 p-6 bg-white/80 backdrop-blur-md rounded-3xl shadow-lg w-full">
                ...
                <div className="mt-3 w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    className="h-3 rounded-full bg-linear-to-r from-purple-500 to-purple-300"
                    style={{ width: "70%" }}
                  ></div>
                </div>
            ...
            <div className="relative flex items-center mb-10">
              <div className="absolute -left-6 w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center shadow-md">
                <div className="w-10 h-10 rounded-full bg-linear-to-r from-yellow-400 to-yellow-200 flex items-center justify-center text-white font-semibold">
                  40%
                </div>
              </div>
              <div className="ml-12 p-6 bg-white/80 backdrop-blur-md rounded-3xl shadow-lg w-full">
                ...
                <div className="mt-3 w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    className="h-3 rounded-full bg-linear-to-r from-yellow-400 to-yellow-200"
                    style={{ width: "40%" }}
                  ></div>
                </div>
