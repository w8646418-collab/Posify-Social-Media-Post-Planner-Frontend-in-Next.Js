...
export default function PostFeatures() {
  ...
  return (
    <>
      ...
      <section className="relative py-24 px-8 bg-linear-to-br from-[#f7f3ff] to-[#d0badd] overflow-hidden mt-23">
        ...
        <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row gap-10 items-center justify-between">
          ...
          <div className="flex flex-col gap-10 w-full md:w-1/2 relative">
            <div className="absolute left-3 top-0 bottom-0 w-0.5 bg-linear-to-b from-[#b026ff] to-[#ff8fe6]"></div>
            ...
            {["Draft your post", "Pick your time", "Confirm schedule"].map(
              (step, i) => (
                ...
                >
                  <div className="shrink-0 w-6 h-6 bg-[#9858d3] rounded-full relative z-10 mt-1"></div>
                  <div>
                    <h4 className="text-lg font-semibold text-[#4b008f]">
                      {step}
                    </h4>
          ...
          >
            {/* Main dashboard card */}
            <div className="bg-white rounded-3xl shadow-2xl border border-[#f0e5ff] p-6 w-[90%] md:w-105 relative overflow-hidden">
              <div className="absolute -top-10 -right-10 bg-linear-to-tr from-[#b026ff] to-[#ff8fe6] rounded-full w-24 h-24 blur-xl opacity-50"></div>
              <div className="absolute -bottom-6 -left-6 bg-linear-to-tr from-[#ff8fe6] to-[#b026ff] rounded-full w-24 h-24 blur-xl opacity-40"></div>
      ...
      <section className="relative py-24 px-8 bg-linear-to-br from-[#ffffff] to-[#f2f1f3] overflow-hidden">
        {/* Background accents */}
        <div className="absolute inset-0 -z-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {analytics.map((item) => (
            ...
            >
              <h3 className="text-xl font-bold text-[#3b006b] mb-3">
                {item.title}
              </h3>
      ...
      <section className="py-24 px-8 bg-linear-to-br from-[#d5cbe9] to-[#d5cbe9]  overflow-hidden">
        <div className="text-center mb-16">
      ...
      <section className="relative py-28 px-8 bg-linear-to-br from-[#f8f5ff] to-[#ffffff] overflow-hidden">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="flex flex-col items-center justify-center bg-white/50 backdrop-blur-xl border border-[#f0e5ff] rounded-3xl shadow-md px-6 py-4 min-w-45 hover:shadow-lg transition"
              >
                <span className="text-4xl mb-2">{item.icon}</span>
                <span className="text-[#3b006b] font-semibold">
                  {item.text}
                </span>
              </motion.div>
            ))}
        ...
        <motion.div
          ...
          className="relative mt-24 max-w-5xl mx-auto bg-linear-to-br from-[#ffffff]/60 to-[#f8f5ff]/40 border border-[#f0e5ff] shadow-lg rounded-3xl p-12 text-center backdrop-blur-md"
        >
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-linear-to-tr from-[#b026ff] to-[#ff8fe6] rounded-full w-20 h-20 blur-xl opacity-50"></div>
      ...
      <section className="relative py-28 px-8 bg-linear-to-br from-[#cfc0ec] to-[#ffffff] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto flex flex-col gap-10 items-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="rounded-4xl overflow-hidden shadow-xl border border-[#f0e5ff]">
                <img
                  src="/images/cthree.jpg"
                  alt="Campaign Spotlight"
                  className="object-cover w-full h-130 hover:scale-105 transition-transform duration-500"
                />
              </div>
              <div className="absolute inset-0 bg-linear-to-t from-[#3b006b]/30 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500 rounded-4xl"></div>
              <motion.span
      ...
      <section className="relative py-28 px-8 bg-linear-to-br from-[#ffffff] to-purple-100 overflow-hidden">
        <div className="absolute inset-0 -z-10">
