...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-b from-white via-blue-50 to-indigo-100 text-gray-800">
      ...
      {/* CALENDAR  */}
      <section className="bg-linear-to-br from-[#250035] via-[#3a005a] to-[#4c006e] py-28 relative overflow-hidden">
      ...
      <section className="bg-linear-to-r from-purple-50 via-indigo-50 to-white py-24">
      ...
      <section className="relative bg-linear-to-b from-white via-indigo-50 to-purple-100 py-24 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-linear(circle_at_20%_20%,rgba(124,58,237,0.15),transparent_70%)]"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 relative overflow-hidden">
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-linear-to-br from-[#7a00cc] to-indigo-400 rounded-full opacity-20 blur-3xl"></div>
            ...
            <div className="relative h-56 flex items-end justify-between gap-2">
              {[30, 50, 40, 65, 80, 70].map((height, i) => (
                <div
                  key={i}
                  className="flex-1 bg-linear-to-t from-indigo-300 to-[#7a00cc] rounded-md transition-all duration-300 hover:opacity-90"
                  style={{ height: `${height}%` }}
                ></div>
              ))}
            </div>
      ...
      {/*INSPIRATION BOARD*/}
      <section className="bg-linear-to-r from-indigo-100 to-white py-20">
      ...
      {/*LOVE  */}
      <section className="relative bg-linear-to-br from-[#4b1c6f] via-[#5c2494] to-[#7a00cc] text-white py-24 overflow-hidden">
      ...
      {/* WORKFLOW */}
      {/* CREATIVE FLOW */}
      <section className="bg-linear-to-r from-white via-indigo-50 to-white py-12">
      ...
      {/* FINAL CTA */}
      <section className="bg-linear-to-r from-[#5c2484] to-[#7a00cc] text-white py-20">
